...
public class Collector_ESTest extends Collector_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(992).when(element0).childNodeSize();
  ...
  public void test1()  throws Throwable  {
      ...
      Node node0 = mock(Node.class, new ViolatedAssumptionAnswer());
      Element element0 = mock(Element.class, new ViolatedAssumptionAnswer());
      doReturn((-308)).when(element0).childNodeSize();
  ...
  public void test2()  throws Throwable  {
      Evaluator evaluator0 = mock(Evaluator.class, new ViolatedAssumptionAnswer());
      doReturn(true, true).when(evaluator0).matches(any(org.jsoup.nodes.Element.class) , any(org.jsoup.nodes.Element.class));
      Node node0 = mock(Node.class, new ViolatedAssumptionAnswer());
      doReturn(0).when(node0).childNodeSize();
      doReturn((Node) null).when(node0).nextSibling();
      doReturn((Node) null).when(node0).parentNode();
      Element element0 = mock(Element.class, new ViolatedAssumptionAnswer());
      doReturn(7).when(element0).childNodeSize();
      doReturn((String) null).when(element0).toString();
      doReturn(node0).when(element0).childNode(anyInt());
      Element element1 = Collector.findFirst(evaluator0, element0);
      // Undeclared exception!
      try { 
        Collector.collect(evaluator0, element1);
        fail("Expecting exception: NullPointerException");
